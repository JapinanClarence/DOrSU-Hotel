...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      <div className="px-40 py-10 mt-32 w-full">
        <div className="mb-10 space-y-10">
          ...
          <p className="text-center text-xl mx-60 font-light">
            Welcome to DOrSU Hotel, where comfort and convenience come together.
            Enjoy a relaxing stay with amenities tailored to meet your needs!
          </p>
        </div>
      ...
      <div
        className="px-40 py-20 mt-20 w-full bg-cover bg-center"
        style={{
